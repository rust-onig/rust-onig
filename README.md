...
at our open [easy issues][easy_issues].
 ...
 [onig_crate_doc]: https://docs.rs/onig/4.0.1/onig/
 [examples_folder]: https://github.com/rust-onig/rust-onig/tree/master/examples
 [regex_new]: https://docs.rs/onig/4.0.1/onig/struct.Regex.html#method.new
 [regex_is_match]: https://docs.rs/onig/4.0.1/onig/struct.Regex.html#method.is_match
 [regex_find]: https://docs.rs/onig/4.0.1/onig/struct.Regex.html#method.find
