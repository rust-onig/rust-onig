...
The contents of this repository are distributed under the MIT license. See [LICENSE](LICENSE.md) for more details.
 ...
 [onig_crate_doc]: https://docs.rs/onig/1.4.0/onig/
 [examples_folder]: https://github.com/rust-onig/rust-onig/tree/master/examples
 [regex_new]: https://docs.rs/onig/1.4.0/onig/struct.Regex.html#method.new
 [regex_is_match]: https://docs.rs/onig/1.4.0/onig/struct.Regex.html#method.is_match
 [regex_find]: https://docs.rs/onig/1.4.0/onig/struct.Regex.html#method.find
